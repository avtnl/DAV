...
def main():
    ...
    bar_positions = [some_index - bar_width, some_index, some_index + bar_width, some_index + 2*bar_width]
    ...
    ax.text(0.03, 1.05, "Anthony", transform=ax.transAxes, ha="left", va="center", fontsize=22, color="red")
