...
DIRECTION_PATTERN = re.compile(
    r"(?:^|[^a-zA-Z])("
    + "|".join(re.escape(term) for term in DIRECTION_TERMS)
    + r")(?=[^a-zA-Z]|$)",
    re.IGNORECASE,
)
...
ROAD_NAMES = {
    key: {
        ...
        "no_format": no_format,
        "format": key if key != "Rest" else None,
    }
    for key, (aliases, road_type, speed_type, no_format) in {
        ...
        "Exprwy": (
            ["Expressway", "express", "epwy", "expy", "expwy", "exp", "expyexit"],
            "Expresswy",
            "High Speed",
            None,
        ),
        ...
        "Hwy": (
            ["Hwy", "highway", "hway", "hwy", "hwyexit", "entry ramp", "exits", "srvd", "serv"],
            "Highway",
            "High Speed",
            None,
        ),
        ...
        "Loop": (
            ["Loop", "loop", "loops", "loopway", "state loop", "loopexit"],
            "Loop",
            "High Speed",
            None,
        ),
        "FM": (
            ["FM-", "FR-", "RM-", "RR", "fm", "fr", "rm", "rr", "farmrd", "farmroad"],
            "Farm-to-Market",
            "High Speed",
            ["FM-", "FR-", "RM-", "RR-"],
        ),
        "Parkwy": (
            ["Parkway", "parkway", "parkwy", "pway", "pwy", "pky", "pkwyexit", "pkyexit"],
            "Parkway",
            "High Speed",
            None,
        ),
        "Speedwy": (
            ["Speedway", "speedway", "speedwy", "sway", "swy"],
            "Speedway",
            "High Speed",
            None,
        ),
        ...
        "Rest": (
            ["Main", "Creek", "Hill", "Market", "School", "Church"],
            "Rest",
            "Low Speed",
            None,
        ),
...
FOGGY = ["Patches of Fog", "Shallow Fog", "Fog", "Mist"]

HAZY = ["Haze / Windy", "Widespread Dust"]
...
SUNNY = ["Clear", "Fair", "Fair / Windy", "Partly Cloudy", "Partly Cloudy / Windy"]

AIRPORT_COORDINATES = {
    "KMCJ": (29.71389, -95.39667),
    "KDAL": (32.84594, -96.85088),
    "KATT": (30.32078, -97.76043),
    "KADS": (32.96856, -96.83644),
    "KRBD": (32.68131, -96.86878),
    "KAUS": (30.19453, -97.66988),
    "KIAH": (29.98444, -95.34144),
    "KHOU": (29.6458, -95.27723),
    "KHQZ": (32.5205, -94.30778),
    "KSGR": (29.62225, -95.65653),
    "KSAT": (29.53396, -98.46906),
    "KELP": (31.80733, -106.37636),
    "KEDC": (29.50614, -95.47692),
    "KDWH": (30.06178, -95.55279),
    "KDFW": (32.89723, -97.03769),
    "KGTU": (30.67881, -97.67939),
    "KBIF": (31.84953, -106.38005),
    "KSPS": (33.9888, -98.4919),
    "KBAZ": (29.70575, -98.04322),
    "KAMA": (35.21936, -101.70592),
    "KJWY": (32.45829, -96.91253),
    "KTPL": (31.1519, -97.40766),
    "KINJ": (32.08364, -97.09725),
    "KDZB": (30.52705, -98.35876),
    "KGGG": (32.384, -94.7115),
    "KTRL": (32.70849, -96.26709),
    "KLFK": (31.23403, -94.75),
    "KODO": (31.92142, -102.38713),
    "KOSA": (33.09689, -94.96175),
    "K6R3": (30.35644, -95.00803),
    "KBBD": (31.17928, -99.32392),
    "KBPG": (32.21262, -101.52165),
    "KCFD": (30.71569, -96.33136),
    "KCNW": (31.63781, -97.07414),
    "KCPT": (32.35375, -97.43375),
    "KGDJ": (32.44307, -97.82137),
    "KGLS": (29.26533, -94.86042),
    "KLRD": (27.54419, -99.46158),
    "KMFE": (26.17583, -98.23861),
    "KMWL": (32.78161, -98.06018),
    "KOCH": (31.57776, -94.71011),
    "KRFI": (32.14172, -94.85173),
    "KT20": (29.52912, -97.4643),
    "KTXK": (33.45372, -93.99103),
    "KACT": (31.61219, -97.23031),
    "KARM": (29.25428, -96.15439),
    "KASL": (32.5205, -94.30778),
    "KBGD": (35.70089, -101.39367),
    "KBKD": (32.71876, -98.8916),
    "KBMT": (30.0702, -94.2151),
    "KBRO": (25.90614, -97.426),
    "KCOT": (28.45572, -99.21722),
    "KCRP": (27.77219, -97.50242),
    "KCRS": (32.02806, -96.40058),
    "KCVB": (29.34239, -98.85122),
    "KDLF": (29.35939, -100.77791),
    "KDUA": (33.9397, -96.39506),
    "KDUX": (35.85743, -102.01331),
    "KDYS": (32.41848, -98.5654),
    "KFST": (30.91525, -102.91278),
    "KGDP": (31.83289, -104.80911),
    "KGNC": (32.67533, -102.65267),
    "KGRK": (31.06725, -97.82892),
    "KGYB": (30.16928, -96.98003),
    "KGYI": (33.71419, -96.67436),
    "KINK": (31.77981, -103.20169),
    "KJAS": (30.88569, -94.03494),
    "KJDD": (32.74219, -95.49647),
    "KLBR": (33.59264, -95.06415),
    "KORG": (30.06845, -93.80402),
    "KPEQ": (31.38239, -103.51072),
    "KPEZ": (28.95419, -98.51997),
    "KPPA": (35.613, -100.99625),
    "KRKP": (28.08622, -97.04369),
    "KSWW": (32.46736, -100.46656),
    "KT82": (30.24325, -98.90919),
    "KUTS": (30.74689, -95.58717),
}
