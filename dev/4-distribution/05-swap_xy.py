...
def main():
    ...
    fig, ax = plt.subplots(figsize=(len(emoji_counts_top) * 0.4, 6))
    ...
    ax.bar(x_positions - bar_width / 2, emoji_counts_top["count_all"], width=bar_width, color="#808080", label="All Occurrences")
    
    # Plot count_once bars (light blue)
    ax.bar(x_positions + bar_width / 2, emoji_counts_top["count_once"], width=bar_width, color="#ADD8E6", label="Once per Message")
