...
def main() -> None:
    ...
    punctuation_counts_df["percent_all"] = (
        (punctuation_counts_df["count_all"] / total_count_all * 100).round(2)
    ...
    punctuation_counts_df.loc[punctuation_counts_df["punctuation"] != "None", "percent_once"] = (
        (punctuation_counts_df["count_once"] / total_count_once * 100).round(2)
    ...
    ax2.set_ylim(
        0, max(punctuation_counts_once["percent_once"]) + 5 if total_count_once > 0 else 100
    )
