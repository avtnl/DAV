...
def main() -> None:
    ...
    ax.text(
        ...
        va="center",
        fontsize=12,
        bbox={"boxstyle": "round", "facecolor": "white", "alpha": 0.0, "edgecolor": None},
    ...
    ax.text(
        ...
        va="center",
        fontsize=12,
        bbox={"boxstyle": "round", "facecolor": "lightgreen", "alpha": 0.0, "edgecolor": "gray"},
        zorder=7,  # Above all elements
    )
    ax.text(
        ...
        va="center",
        fontsize=12,
        bbox={"boxstyle": "round", "facecolor": "green", "alpha": 0.0, "edgecolor": None},
        zorder=7,  # Above all elements
    )
    ax.text(
        ...
        va="center",
        fontsize=12,
        bbox={"boxstyle": "round", "facecolor": "white", "alpha": 0.0, "edgecolor": "gray"},
        zorder=7,  # Above all elements
    )
