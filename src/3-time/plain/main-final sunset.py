...
def main():
    ...
    logger.info(f"Sunset message counts: {sun_set_counts}")
    ...
    ax.set_xticklabels(combined_labels, ha="right", fontsize=9)
    ax.set_xlabel("Week of Year / Month")
    ax.set_ylabel("Message Count")
    plt.title("Golf season decoded by WhatsApp heartbeat", fontsize=24)

    output_path = Path("img/average_messages_by_week_with_labels_and_rest.png")
