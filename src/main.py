...
def main():
    ...
    # Prepare common variables for steps 1, 4, 5, 6, 7, 8
    group_authors, non_anthony_group, anthony_group, sorted_groups = None, None, None, None
    if any(step in Script for step in [1, 4, 5, 6, 7, 8]):
    ...
    steps = {
        ...
        6: scripts.Step6Script(file_manager, data_editor, data_preparation, plot_manager, image_dir, tables_dir, processed),
        7: scripts.Step7Script(file_manager, data_preparation, plot_manager, image_dir, group_authors),
        10: scripts.Step10Script(file_manager, data_editor, processed, tables_dir),
